            ...
            <tbody>
                @forelse ($planes as $portItem)
                 <tr>
                    ...
                    <td>
                        <a {{-- href="{{route('planes.edit'),$portItem }}" --}} class=" btn btn-warning">
                    ...
                    {{-- <td class="border  text-center px-0 py-2">
                        <a href="{{ route('planes.edit', $portItem) }}" class=" btn btn-warning">
                            <svg class="bi bi-receipt" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalCenterTitle">Elimnar Plan</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <form method="POST" action="{{ route('planes.destroy', $portItem) }} ">
                                        @csrf @method('DELETE')
                                        <input type="hidden" id="idDelete" name="idDelete" value="">
                                        <div class="modal-body">
                                            ¿Estas seguro que deseas eliminar el plan?
                                        </div>
